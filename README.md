...
1. **녹음은 많지만 활용은 적다**  
   - 학생들은 수업을 녹음해 두지만, 필요한 내용을 다시 찾기 어려워 결국 녹음 파일을 잘 활용하지 않게 됩니다.

2. **교수님이 강조한 부분을 다시 찾기 어렵다**  
   - 수업을 다시 들을 때도 어떤 내용이 중요했고, 교수님이 어디를 특히 강조했는지 바로 파악하기 어렵습니다.

3. **슬라이드와 음성이 분리되어 있어 복습 흐름이 끊긴다**  
   - 슬라이드만 봐서는 설명 맥락이 부족하고, 음성만 들어서는 어느 자료를 설명하는지 알기 어려워 복습 효율이 떨어집니다.
---

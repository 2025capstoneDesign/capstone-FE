  ...
  return (
    <div className="relative h-[510px] min-w-[1600px] overflow-hidden mx-auto">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(130deg, #1A4642 0%, #80CBC4 53%, #B4EBE6 65%, #D9E1BB 78%, #FDD691 97%)",
          opacity: 1,
        }}
      />
      ...
      <div className="relative z-10 p-20 justify-between items-center h-full">
        <div className="">
          <h1 className=" px-36 text-4xl font-[350] text-white tracking-wide">
            필기요정과 함께!
          </h1>
          <h1 className="py-4 px-36 text-6xl text-white font-[580] tracking-wide">
            자동 필기 생성 서비스
          </h1>
          <p className="mt-16 text-white font-[350] px-36 text-xl tracking-wide">
            ...
            <br />
            AI가 도와주는{" "}
            <span className="text-orange-300 font-[450]">
              스마트한 필기 정리
            </span>
            를 경험해보세요.
          </p>

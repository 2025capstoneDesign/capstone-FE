                ...
                const commonContent = (
                   <>
                      <span className="text-[1.4rem] font-semibold">
                            ...
                            <p class="text-gray-700 mt-1">왼쪽 업로드 영역에 <span class="font-semibold text-[#5B7F7C]"> 강의록 파일</span> 과 <span class="font-semibold text-[#5B7F7C]"> 음성 파일</span> 을 업로드해주세요.</p>
                            <p class="text-gray-700">파일을 업로드하고 변환을 시작하면  <span class="font-semibold text-[#5B7F7C]">AI가 작성한 필기</span>를 확인할 수 있습니다.</p>
                            <br />
          ...
          <div className="manual-content">
            {/* <p className="text-[1.1rem] text-gray-700"> */}
              ...
              <br />
                <span className="text-[1.2rem] font-semibold"><RiQuillPenAiFill className="text-xl mb-1 inline mr-1 text-[#80cbc4]"/> 파일 업로드</span>
                <p class="text-gray-700 mt-1">왼쪽 업로드 영역에 <span class="font-semibold text-[#5B7F7C]"> 강의록 파일</span> 과 <span class="font-semibold text-[#5B7F7C]"> 음성 파일</span> 을 업로드해주세요.</p>
                <p class="text-gray-700">파일을 업로드하고 변환을 시작하면  <span class="font-semibold text-[#5B7F7C]">음성 원본</span>를 확인할 수 있습니다.</p>
              <br />
            {/* </p> */}
            {/* <p className="text-[1.1rem] text-gray-700"> */}

      ...
      <div className="flex gap-8 flex-1 min-h-[900px]">
        ...
        <div className="flex-1 border-4 border-gray-100 rounded-xl p-16 flex flex-col">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-3xl font-medium">강의록과 음성을 업로드하여 요약된 필기 내용을 확인해보세요</h2>
            <button className="bg-[#5B7F7C] text-white px-8 py-3 rounded-full font-[350] text-xl hover:bg-[#455E5C] transition-colors">
              변환하기
            </button>
          </div>
          ...
          <div className="flex gap-8 flex-1">
            ...
            <div className="flex-1 flex flex-col h-[450px]">
              ...
              >
                ...
                <p className="text-gray-500 text-bold-md text-lg"><span className="text-[#5B7F7C]">클릭</span>하여 파일을 업로드하세요</p>
              </div>
